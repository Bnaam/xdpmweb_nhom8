         ...
         <div class="card">
           ...
           <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="text" id="txt_tensp" name="txt_tensp" class="form-control" value="{{old('txt_tensp') ?? $detail->tensp}}">
            </div>
            @error('txt_tensp')
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="number" id="txt_soluongsp" name="txt_soluongsp" class="form-control" value="{{old('txt_soluongsp') ?? $detail->soluong}}"></div>
            @error('txt_soluongsp')
                <span style="color: red;float: right">{{$message}}</span>
            @enderror
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="text" id="txt_Giamoi" name="txt_Giamoi" class="form-control" value="{{old('txt_Giamoi') ?? $detail->giamoi}}"></div>
            @error('txt_Giamoi')
                <span style="color: red;float: right">{{$message}}</span>
            @enderror
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="text" id="txt_mau" name="txt_mau" class="form-control" value="{{old('txt_mau') ?? $detail->mausac}}"></div>
            @error('txt_mau')
                <span style="color: red;float: right">{{$message}}</span>
            @enderror
            </div>
             ...
             <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><textarea name="txt_mota" id="txt_mota" rows="9" class="form-control" value="{{old('txt_mota') ?? $detail->mota}}">{{$detail->mota}}</textarea></div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9" >
                    <select name="cbx_danhmuc" id="cbx_danhmuc" class="form-control" required>
                      <option value="{{$detail->madm}}" hidden>{{$detail->tendm}}</option>
