			  ...
			  <div class="table-responsive">
               <table class="table">
                  ...
                  <tbody>
                    ...
                    <td>{{$data->ngaygiaohang}}</td>

                    
                    <td>
                    <a href="{{route('orders.editform', ['id'=>$data->madh])}}" class="btn btn-outline-warning btn-sm" style="color: rgb(255 255 255 / 85%)"><i class="fa fa-edit (alias)"></i>&nbsp; Sửa</a>
