         ...
         <div class="card">
           ...
           <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <div class="row form-group">
              ...
              <div class="col-12 col-md-9"><input type="text" id="txt_ten" name="txt_ten" class="form-control" value="{{old('txt_ten') ?? $detail->tenkh}}">
          </div>
          @error('txt_ten')
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="email" id="email" name="email"  class="form-control" value="{{old('email') ?? $detail->email}}"></div>
              @error('email')
                  <span style="color: red">{{$message}}</span>
              @enderror
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="password" id="txt_password" name="txt_password"  class="form-control" value="{{old('txt_password') ?? $detail->password}}"></div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="text" id="txt_sdt" name="txt_sdt" class="form-control" value="{{old('txt_sdt') ?? $detail->sdt}}"></div>
            </div>
            
            <div class="row form-group">
                <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Địa chỉ</label></div>
                <div class="col-12 col-md-9"><textarea name="txt_diachi" id="txt_diachi" rows="3" class="form-control" value="{{old('txt_diachi') ?? $detail->diachi}}">{{$detail->diachi}}</textarea></div>
            </div>
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-9" >
                  <select name="cbx_trangthai" id="cbx_trangthai" class="form-control" required>
                    <option value="{{$detail->trangthai}}" hidden>{{$detail->trangthai}}</option>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9" >
                    <select name="cbx_role" id="cbx_role" class="form-control" >
                      <option value="{{$detail->role}}" hidden>{{$detail->role}}</option>
            ...
            <div class="row form-group">
              ...
              <div class="col col-md-9">
                  ...
                  @if($detail->gioitinh == "Nam")
                  <div class="radio">
                          <label for="radio1" class="form-check-label ">
                              <input type="radio" id="rad_nam" name="rad_gt" value="Nam" class="form-check-input" checked>Nam
                          </label>
                      </div>
                      <div class="radio">
                   ...
                   <div class="radio">
                      ...
                      <div class="radio">
                          <label for="radio2" class="form-check-label ">
                              <input type="radio" id="rad_nu" name="rad_gt" value="Nữ" class="form-check-input" checked>Nữ
                          </label>
                      </div>
                      @endif
