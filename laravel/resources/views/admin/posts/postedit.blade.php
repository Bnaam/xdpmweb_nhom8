            ...
            <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="text" id="tieude"
                            name="tieude" class="form-control" value="{{old('tieude') ?? $detail->tieude}}">
                    </div>
                    @error('tieude')
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><textarea name="txt_noidung" id="txt_noidung"
                            rows="9" class="form-control" value="{{old('txt_noidung') ?? $detail->noidung}}">{{$detail->noidung}}</textarea></div>
                    @error('txt_noidung')
                        <span style="color: red;float: right">{{$message}}</span>
                    @enderror
                </div>
